...
def payments(request):
    ...
    mail_subject = 'Thank you for your purchase with FinalProject!'
...
def place_order(request, total=0, quantity=0):
    ...
    if cart_count <=0: # check are there cart items in the cart
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            #Store all billing data inside table Order
            data = Order()
